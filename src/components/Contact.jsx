  ...
  },
  {
    ...
    icon: (
      <svg
        ...
        height="24"
      >
        <path d="M22.675 0H1.325C.593 0 0 .593 0 1.326V22.67c0 .733.593 1.326 1.325 1.326h11.497V14.7h-3.13v-3.63h3.13V8.413c0-3.1 1.892-4.788 4.658-4.788 1.325 0 2.464.1 2.796.144v3.24h-1.918c-1.504 0-1.794.716-1.794 1.764v2.31h3.587l-.467 3.63h-3.12v9.296h6.116c.733 0 1.326-.593 1.326-1.326V1.326C24 .593 23.407 0 22.675 0z" />
      </svg>
    ),
    alt: "Facebook",
  },
    ...
    <section className="section" id="contact">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col ">
          ...
          <p className="text-zinc-400 max-w-[50ch] lg:max-w-[30ch]">
            Reach out today to discuss your project needs and start
            collaborating on something amazing!
          </p>
          <p className="text-zinc-400 max-w-[50ch] lg:max-w-[30ch] mt-2 mb-8"> <span>Phone number: 01567989506</span> <br /> <span>WhatsApp number: 01783030598</span> </p>

          <div className="flex items-center gap-2 mt-auto">
            {socialLinks.map(({ href, icon }, key) => (
              <a key={key} href={href} target="_blank" className="reveal -up w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-[background-color,color] hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/80">
                {icon}
              </a>
            ))}
          </div>
        ...
        <form action="https://getform.io/f/amddeyob" method="POST" className="xl:pl-10 2xl:pl-20">
          <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                id="email"
                autoComplete="email"
                placeholder="smsiam987@gmail.com"
                required
                className="text-field reveal -up"
              />
            </div>
