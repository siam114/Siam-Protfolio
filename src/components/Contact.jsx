    ...
    <section className="section" id="contact">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col ">
          ...
          <p className="text-zinc-400 max-w-[50ch] lg:max-w-[30ch] mt-2 mb-8">
            {" "}
            <span>Phone number: 01567989506</span> <br />{" "}
            <span>WhatsApp number: 01783030598</span>{" "}
          </p>
        ...
        <form
          action="https://getform.io/f/amddeyob"
          method="POST"
